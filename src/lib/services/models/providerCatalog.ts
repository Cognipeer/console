...
export const PROVIDER_DEFINITIONS: ProviderDefinition[] = [
  {
    id: 'openai',
    label: 'OpenAI',
    description: 'Official OpenAI platform supporting GPT-4.1, GPT-4o, and text-embedding models.',
  ...
  },
  {
    ...
    description: 'Any API that follows the OpenAI REST schema (e.g., Mistral, Groq, Cerebras).',
    categories: ['llm', 'embedding'],
    credentialFields: [
      {
        name: 'apiKey',
  ...
  },
  {
    ...
    description: 'Bedrock Converse API supporting Anthropic, AI21, and other foundation models.',
    categories: ['llm', 'embedding'],
    credentialFields: [
      {
        name: 'accessKeyId',
    ...
    defaultPricingCurrency: 'USD',
    modelIdHint: 'e.g., anthropic.claude-3-sonnet-20240229-v1:0, amazon.titan-text-express-v1'
  },
  {
    id: 'vertex',
    label: 'Google Vertex AI',
    description: 'Vertex AI generative and embedding models using service account credentials.',
    categories: ['llm', 'embedding'],
    credentialFields: [
      {
        name: 'projectId',
