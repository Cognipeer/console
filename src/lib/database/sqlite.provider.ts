...
import { PrescriptionMixin } from './sqlite/prescription.mixin';
...
import { WebSearchMixin } from './sqlite/websearch.mixin';
...
import { ExternalModelPricingMixin } from './sqlite/external-model-pricing.mixin';
...
const PrescriptionsBase = PrescriptionMixin(AlertingBase);
const KnowledgeBase = MemoryMixin(WebSearchMixin(RerankerMixin(RagMixin(PrescriptionsBase))));
